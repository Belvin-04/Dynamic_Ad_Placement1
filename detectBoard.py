...
def run(
        ...
        source='../data/test/images',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / '../data/test/images', help='file/dir/URL/glob, 0 for webcam')
